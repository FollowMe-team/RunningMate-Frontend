    ...
    <TouchableOpacity onPress={handledetail}>
      {Isdetail === false ? (
        <View style={styles.smallbox}>
          ...
          >
            ...
            >
              ...
              <Text
                style={[
                  data.difficulty === '쉬움' && styles.lowlevel,
        ...
        <View style={styles.smallbox_choosed}>
          ...
          >
            <TouchableOpacity
              onPress={() => navigation.navigate('Reviewed', { id: data.id })}
            >
              <View style={styles.whitebutton_look}>
                <Text style={styles.greentext_look}>상세 보기</Text>
                <Image style={{ width: 14, height: 14 }} source={greenQmark} />
              </View>
            </TouchableOpacity>
            <TouchableOpacity
              onPress={() => navigation.navigate('Runningtime', { data: data })}
            >
              <View style={styles.greenbutton_run}>
                <Text style={styles.whitetext_run}>달리기</Text>
                <Image style={{ width: 14, height: 14 }} source={runningman} />
              </View>
            </TouchableOpacity>
          </View>
        </View>
