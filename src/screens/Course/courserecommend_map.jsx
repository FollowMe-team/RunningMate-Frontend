    ...
    <View style={styles.container}>
      ...
      >
        ...
        >
          ...
          >
            <Image
              ...
              source={location}
            />
            <Text style={{ color: 'grey', fontSize: 8 }}>3.8KM</Text>
          </View>
          <View
            style={{
              flexWrap: 'wrap',
          ...
          >
            <Image
              ...
              source={time}
            />
            <Text style={{ color: 'grey', fontSize: 8 }}>30~40분</Text>
          </View>
        </View>
        ...
        <View style={{ flexDirection: 'row' }}>
          ...
          >
            산을 따라서 달리는 하드코어 러닝 코스입니다. 숙련자만 달리시길
            권장드립니다.
          </Text>
        ...
        <View style={{ flexWrap: 'wrap', flexDirection: 'row' }}>
          ...
          >
            <Image
              ...
              source={runner}
            />
            <Text style={{ fontSize: 12 }}>1000명</Text>
          </View>
        </View>
        <View style={styles.space}></View>
        <View
