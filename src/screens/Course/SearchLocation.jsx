        ...
        <View style={styles.container}>
            ...
            {selectedLocation && (
                <View style={styles.addressContainer}>
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate('Coursesearch', {selectedLocation : {latitude : selectedLocation.latitude, longitude: selectedLocation.longitude, address: address}})}
